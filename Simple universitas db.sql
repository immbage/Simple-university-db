...
INSERT INTO
    universitas.mahasiswa(id_mhs, nama_mahasiswa, id_dosen_wali)
VALUES
...
ALTER TABLE
    universitas.mahasiswa
MODIFY
    COLUMN id_mhs INTEGER;

EXPLAIN universitas.mahasiswa;

ALTER TABLE
    universitas.mahasiswa CHANGE COLUMN id_mhs nomor_induk_mahasiswa varchar(50);
